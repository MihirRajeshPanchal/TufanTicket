      ...
      <section className="bg-primary-50 bg-dotted-pattern bg-contain py-5 md:py-10">
        ...
        <section className="bg-gradient-to-b from-primary-50 to-white py-5 md:py-10 min-h-[600px] relative overflow-hidden">
          <div className="wrapper">
            <h2 className="h2-bold text-center mb-12">Featured For You</h2>
            ...
            {randomEvent && (
              <div className="relative w-full flex justify-center items-center min-h-[600px]">
                ...
                <div className="absolute inset-0">
                  ...
                  <div className="absolute w-[3cm] h-[3cm] animate-comet-1">
                    <div className="w-full h-full relative">
                      ...
                      <div className="absolute h-1 w-12 -right-12 top-1/2 
                ...
                {/* Featured Event Card */}
                <div className="relative z-10 w-[350px] bg-white/90 backdrop-blur-sm rounded-2xl 
                  ...
                  <div className="flex flex-col gap-4 mt-5">
                    <h3 className="h3-bold text-center line-clamp-1">
                      {randomEvent.title}
                    </h3>
                    
                    <p className="p-regular-16 text-center text-gray-600 line-clamp-2">
                      {randomEvent.description}
                    </p>

                    <div className="flex flex-wrap gap-2 justify-center">
                      <p className="px-4 py-2 rounded-full bg-primary-50/80 text-primary-500 text-sm font-medium">
                        {randomEvent.isFree ? 'FREE' : `$${randomEvent.price}`}
                      </p>
                    ...
                    <Button asChild className="w-full">
                      <Link href={`/events/${randomEvent._id}`}>
                        View Details
                      </Link>
                    </Button>
                  </div>
